...
var logger = log4js.getLogger('ezscanfile-api');
...
app.post('/ezscanfile/:channelName/:chaincodeName/invoke/v1', async function(req, res) {
...
app.post('/ezscanfile/:channelName/:chaincodeName/query/v1', async function(req, res) {
...
app.post('/ezscanfile/asdce/a/v1', async function(req, res) {
...
app.post('/ezscanfile/asdce/u/v1', async function(req, res) {
	logger.info('===============新增新user===============');
	var values = req.body.values;
	logger.debug('values  : ' + values);
	if (!values) { res.json(getErrorMessage('\'values\'')); return; }
